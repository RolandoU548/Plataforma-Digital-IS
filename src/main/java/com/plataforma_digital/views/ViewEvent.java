...
public class ViewEvent extends javax.swing.JPanel {
        ...
        private void initComponents() {
                ...
                end.setFont(new java.awt.Font("Segoe UI", 1, 15));
                end.setText("Fecha Fin: " + event.getEndDate());

                place.setFont(new java.awt.Font("Segoe UI", 1, 15));
                place.setText("Lugar: " + event.getLocation());
